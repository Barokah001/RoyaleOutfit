// app/policy/shipping/page.tsx - Brown Theme
"use client";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-brand-brown-600">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-brown text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-cream-100 mb-3">
                <Truck className="h-6 w-6 text-primary" />
              </div>
              <h3 className="font-bold text-brand-brown-800 mb-1">
                Free Shipping
              </h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-brown text-center">
              ...
              <p className="text-sm text-brand-brown-600">3-7 business days</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-brown text-center">
              ...
              <p className="text-sm text-brand-brown-600">Real-time tracking</p>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white p-8 rounded-xl shadow-brown-lg mb-8"
          >
            <h2 className="text-3xl font-bold text-brand-brown-800 mb-6 font-display">
              Shipping Information
            </h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-brand-brown-800 mb-3">
                  Shipping Rates
                </h3>
                <div className="bg-brand-cream-100 p-4 rounded-lg">
                  <ul className="space-y-2 text-brand-brown-700">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-brand-cream-100 p-4 rounded-lg">
                    <h4 className="font-semibold text-brand-brown-800 mb-2">
                      Custom Orders
                    </h4>
              ...
              <div>
                ...
                <p className="text-brand-brown-700 mb-3">
                  We deliver to all states in Nigeria. Major cities (Lagos,
                  Abuja, Port Harcourt, etc.) typically receive faster delivery
                  times.
                </p>
                <div className="bg-amber-50 border-l-4 border-amber-500 p-4">
                  <p className="text-amber-900 text-sm">
                    <strong>International Shipping:</strong> Available to select
                    countries. Contact us for rates and delivery times.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-brand-brown-700">
                  ...
                  number via email and SMS. Use this number to track your
                  package in real-time through our courier partner&apos;s
                  website.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-brand-brown-700 mb-4">
                  ...
                  you&apos;re not happy, here&apos;s what you need to know:
                </p>
                <ul className="space-y-2 text-brand-brown-700">
                  <li className="flex items-start">
                    <span className="text-primary mr-2 mt-1">✓</span>
                    <span>
                      You have <strong>14 days</strong> from delivery to return
                      eligible items
                    </span>
                  </li>
                  <li className="flex items-start">
              ...
              <div>
                ...
                <div className="bg-brand-cream-100 p-6 rounded-lg">
                  <ol className="space-y-3 text-brand-brown-700">
                    <li className="flex">
                      <span className="font-bold text-primary mr-3">1.</span>
                      <span>
                        Contact us at mubarakadegbenga@gmail.com or +234 901 461
                        8785
                      </span>
                    </li>
                    <li className="flex">
                    ...
                    <li className="flex">
                      ...
                      <span>
                        Ship to our address (we&apos;ll provide return shipping
              ...
              <div>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                  <p className="text-blue-900 text-sm">
                    <strong>Custom Items:</strong> One free alteration within 14
                    days if the fit isn&apos;t perfect.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-brand-brown-700 mb-3">
                  ...
                  immediately with photos. We&apos;ll arrange for a replacement
                  or full refund, including return shipping costs.
                </p>
                <div className="bg-red-50 border-l-4 border-red-500 p-4">
                  <p className="text-red-900 text-sm">
                    <strong>Important:</strong> Inspect your order upon delivery
                    and report any issues within 48 hours for fastest
                    resolution.
                  </p>
                </div>
              </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-br from-primary to-brand-brown-700 p-8 rounded-xl text-white text-center shadow-brown-lg"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="inline-block bg-white text-primary px-8 py-3 rounded-full font-semibold hover:bg-brand-cream-100 transition-colors shadow-brown"
              >
                Contact Us
              </a>
              <a

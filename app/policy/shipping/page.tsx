                ...
                <div className="bg-[#faf9f6] p-4 rounded-lg">
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex justify-between">
                      ...
                      <span className="font-semibold text-[#4a5d3f]">FREE</span>
                    </li>
                    <li className="flex justify-between">
              ...
              <div>
                ...
                <div className="bg-[#faf9f6] p-6 rounded-lg">
                  <ol className="space-y-3 text-gray-700">
                    <li className="flex">
                      <span className="font-bold text-[#4a5d3f] mr-3">1.</span>
                      <span>
                    ...
                    <li className="flex">
                      <span className="font-bold text-[#4a5d3f] mr-3">2.</span>
                      <span>
                        Provide your order number and reason for return
                      </span>
                    </li>
                    <li className="flex">
                      <span className="font-bold text-[#4a5d3f] mr-3">3.</span>
                      <span>Receive a Return Authorization (RA) number</span>
                    </li>
                    <li className="flex">
                      <span className="font-bold text-[#4a5d3f] mr-3">4.</span>
                      <span>
                        Pack the item securely with the RA number visible
                      </span>
                    </li>
                    <li className="flex">
                      <span className="font-bold text-[#4a5d3f] mr-3">5.</span>
                      <span>

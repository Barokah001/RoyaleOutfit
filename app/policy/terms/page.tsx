// app/policy/terms/page.tsx - Brown Theme
"use client";
    ...
    <div className="min-h-screen bg-brand-cream-200 py-12">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Introduction */}
          <div className="bg-white p-8 rounded-xl shadow-brown-lg mb-8">
            <p className="text-brand-brown-700 leading-relaxed">
              ...
              website, products, and services. Please read these terms carefully
              before placing an order or using our services.
            </p>
          </div>
          ...
          <div className="space-y-6">
            {sections.map((section, index) => (
              <motion.div
                ...
                className="bg-white p-6 md:p-8 rounded-xl shadow-brown"
              >
                <h2 className="text-2xl font-bold text-brand-brown-800 mb-4">
                  {section.title}
                </h2>
                ...
                {section.subsections && (
                  <div className="space-y-4">
                    {section.subsections.map((subsection, subIndex) => (
                      <div key={subIndex}>
                        <h3 className="text-lg font-semibold text-brand-brown-800 mb-2">
                          {subsection.subtitle}
                        </h3>
                        <p className="text-brand-brown-700 leading-relaxed pl-4">
                          {subsection.text}
                        </p>
                      </div>
                    ))}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mt-12 bg-gradient-to-br from-primary to-brand-brown-700 p-8 rounded-xl text-white text-center shadow-brown-lg"
          >
